...
if __name__ == "__main__":
    ...
    test_context = {
        ...
        "mixed_path": os.path.join(os.environ.get("VIDEO_FACTORY_OUTPUT", "output"), "step11_final.mp4"),
        "voice_path": os.path.join(os.environ.get("VIDEO_FACTORY_OUTPUT", "output"), "step05_voice.wav"),
    }
