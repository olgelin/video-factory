...
# 参考音频
DEFAULT_REF_WAV = os.environ.get("VOICE_REF_WAV", "")

# VoxCPM2模型路径
VOXCPM_MODEL = os.environ.get("VOXCPM_MODEL", "")
...
if __name__ == "__main__":
    test_context = {
        "script_path": os.path.join(context.get("output_dir", "output"), "step03_script.json"),
    }
