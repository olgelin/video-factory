...
if __name__ == "__main__":
    ...
    test_context = {
        ...
        "script_path": os.path.join(os.environ.get("VIDEO_FACTORY_OUTPUT", "output"), "step03_script.json"),
        "design_md_path": os.path.join(os.environ.get("VIDEO_FACTORY_OUTPUT", "output"), "design.md"),
    }
