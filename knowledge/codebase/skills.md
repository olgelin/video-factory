...
**描述**: (无描述)
**代码行数**: 91
**主要函数**: _calc_duration_by_lyrics, run
**SKILL.md**: ✅
...
**代码行数**: 2280
**主要函数**: call_llm, call_llm_for_html, load_design_system, load_design_specs, load_design_system_json, _load_gsap_inline, _load_three_inline, generate_scene_html_llm
**日志标签**: hf_builder
**SKILL.md**: ✅
...
**描述**: (无描述)
**代码行数**: 174
**主要函数**: _repair_truncated_json, _load_prompt, run
**SKILL.md**: ❌ 缺失
...
**描述**: (无描述)
**代码行数**: 240
**主要函数**: _load_prompt, generate_lyrics, _generate_fallback_lyrics, run
**SKILL.md**: ✅
...
**描述**: (无描述)
**代码行数**: 150
**主要函数**: _load_prompt, _parse_json, run
**SKILL.md**: ❌ 缺失
...
**描述**: (无描述)
**代码行数**: 491
**主要函数**: check_video_basics, check_blank_frames, check_audio_levels, check_subtitle_coverage, check_subtitle_timing, _parse_srt_time, check_html_css_classes, check_ghost_elements
**SKILL.md**: ❌ 缺失
...
**描述**: (无描述)
**代码行数**: 248
**主要函数**: run, _basic_clean, _process_with_llm, _parse_json
**SKILL.md**: ❌ 缺失
...
**日志标签**: 抖音热搜, B站热搜, 热点采集, V2EX, 今日头条, 百度热搜
**SKILL.md**: ✅
...
**描述**: (无描述)
**代码行数**: 436
**主要函数**: _load_prompt, select_topic, _select_from_topics_list, _select_from_report, _search_real_data, run
**SKILL.md**: ✅
...
**描述**: (无描述)
**代码行数**: 382
**主要函数**: _safe_read_html, _safe_write_html, _normalize_html_encoding, _fix_duplicate_styles, _simplify_composition_gsap, run_hyperframes_render, _render_fallback_frame, _validate_html_structure
**SKILL.md**: ✅
...
**代码行数**: 151
**主要函数**: _find_video2x, _check_upscale_valid, run
**日志标签**: upscaler
**SKILL.md**: ✅
...
**描述**: (无描述)
**代码行数**: 183
**主要函数**: _extract_frames, _check_frame_with_vision, run
**SKILL.md**: ❌ 缺失
