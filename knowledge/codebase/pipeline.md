...
| 7.5 | lyric_scene_designer | lyric_scene_designer |
| 9 | storyboard | storyboard_lyric |
...
| 12 | audio_mixer | audio_mixer_lyric |
| 14 | quality_checker | quality_checker |

## edu-video (`edu_video.yaml`)
...
## short-video-news (`short_video.yaml`)

短视频资讯全自动生产线。从热点采集到成品视频，全流程自动化。
