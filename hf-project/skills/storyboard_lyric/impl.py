...
def _load_prompt(name): 
    ...
    if not p.exists(): raise FileNotFoundError(f"Prompt missing: {p}")
...
def run(context: dict) -> dict:
    ...
    if lyrics_path.exists():
        ...
        print(f"  [storyboard_lyric] 无歌词文件，跳过BGM场景")
