...
风格规范（Ali厂长科技风）：
- 口语化，去AI化，像真人博主在说话
- 有节奏感：开场冲击→数据支撑→情感升华→金句收尾
- 不要用"啊哥"、"宝子们"等过时称呼
- 不要用"首先...其次...最后"这种AI排比
- 不要用"值得注意的是"、"需要指出的是"等AI腔
- 要有冲突感、反差感、悬念感
"""
...
NUMBER_WORDS = {
    ...
    '100000': '十万', '1000000': '一百万', '10000000': '一千万',
    '100000000': '一亿', '2000': '两千', '3000': '三千',
    '5000': '五千', '8000': '八千', '10000': '一万',
    '20000': '两万', '50000': '五万', '100000': '十万',
    '200000': '二十万', '500000': '五十万', '1000000': '一百万',
}
...
"""
    ...
    system_prompt = f"""你是一个短视频口播博主，风格是「未来伦理锐评风」——设问开场+犀利分析+金句收尾。
...
### 语言要求（强制）
- 口语化程度9/10，像真人博主在跟你聊天
- 必须使用标志性表达：你品、细品、说白了、真相是、我翻遍全网、别被忽悠了
- 绝对禁止：值得注意的是、需要指出的是、首先其次最后、总而言之、宝子们、家人们

### 结尾要求（强制）
- 最后一个段落必须用金句收尾，让人记住或想转发
- 示例："记住，技术无罪，人心决定方向。" / "觉得有用？转发给需要的人！"
