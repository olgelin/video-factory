...
```html
<div id="scene" class="scene" style="position:relative;width:1080px;height:1920px;overflow:hidden;background:linear-gradient(180deg,#060618,#0A0C26,#0C1030);">
...
- 🔴 90% 安全区（1080×1920 竖屏）：左右 54px、上下 96px。垂直填满不留大片空白
